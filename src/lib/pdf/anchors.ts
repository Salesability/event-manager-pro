...
// top-left origin, page units (points), 1-indexed page number (top-left
// confirmed by the 0055 live smoke). The renderers translate from pdf-lib's
// bottom-left origin at capture time, so consumers never deal with pdf-lib's
// convention.
