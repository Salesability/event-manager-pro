...
>) {
  return (
    <Headless.Dialog {...props}>
      ...
      {/* z-50 matches dialog.tsx's panel layer — an Alert opened from inside a
          Dialog (e.g. a confirm) is portaled later, so the equal z-index lets
          DOM order paint it above the host dialog instead of behind it. */}
