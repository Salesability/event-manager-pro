...
// Sales Coaches retired in 0020 Phase 4 — manage coaches (and every other
// person) on /admin/people. This page is now dealerships-only.
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-600">
            Dealerships in the system. People (including coaches) live on{' '}
            <a className="text-status-blue underline" href="/admin/people">
              the People page
            </a>
            .
          </p>
