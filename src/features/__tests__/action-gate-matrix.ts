...
export const ACTION_MATRIX: ActionMatrixRow[] = [
  ...
  {
    label: 'createSalesLeadSource',
    invoke: () => scheduleActions.createSalesLeadSource(fd()),
    expectedByRole: ADMIN_ONLY,
    note: 'lookup:edit — admin-only',
  },
  {
    label: 'updateSalesLeadSource',
    invoke: () => scheduleActions.updateSalesLeadSource(fd()),
    expectedByRole: ADMIN_ONLY,
    note: 'lookup:edit — admin-only',
  },
  {
    label: 'archiveSalesLeadSource',
    invoke: () => scheduleActions.archiveSalesLeadSource(fd()),
    expectedByRole: ADMIN_ONLY,
    note: 'lookup:edit — admin-only',
  },
