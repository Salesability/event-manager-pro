...
Phase 3 of the port migration (`docs/chunks/0004-port-migration/plan.md`). This doc works through the mapping and auth decisions before writing `scripts/import-from-sheets.ts`. Schema source of truth: `docs/wiki/data-model.md`.
