...
- [x] Smoke (web-test, single gated route): seeded fixture dealer #165, `goto /dealerships/165` (admin auth injected) → **PASS** — heading "0070 Push Smoke Motors", QuickBooks section ("Not in QuickBooks yet"), **"Push to QuickBooks"** button (`@e70`) all render against the live sandbox QB connection. Did not click (read-only). Cleaned up after. Screenshot `/tmp/web-test-0070-dealer-push.png`. (Exercised by the chunk-end `/eval`, report `eval-2026-06-09-1211.md`.)
