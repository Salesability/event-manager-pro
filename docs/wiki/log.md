...
- Eight-phase plan landed at `docs/designs/0019-security-architecture/`. Five active phases shipped (1, 2, 3, 4, 7); two parked (5 boundary-discipline checks, 6 MFA enablement) for marginal-value reasons documented in the plan; Phase 8 wiki updates close the chunk.
