...
- Why this split: see `shipped/0019-security-architecture/plan.md` Decision #1 for the full reasoning. Originally targeted in `shipped/0002-nextjs-scaffold/decision.md:10`; the codebase had drifted to "Drizzle owns everything" before 0019 re-aligned the policies to the original hybrid intent.
