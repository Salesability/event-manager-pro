...
| Future integrations | Stripe (invoicing/payments), Dropbox Sign (e-sign), Resend + React Email (outbound mail) | Each lands in its own chunk per the migration order in `docs/designs/closed/0001-port-stack-analysis/notes.md`. |
